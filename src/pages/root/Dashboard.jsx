...
export default function DashboardRoot() {
  ...
  return (
    <DashboardLayout>
      {/* r s nota: a margem esquerda (ml-72 ou ml-64) é controlada 
          dentro do seu dashboardlayout para compensar a sidebar fixa.
      */}
      <div className="space-y-8 pb-20">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          ...
          <button 
            ...
            className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black flex items-center gap-3 hover:bg-cept-blue transition-all shadow-xl shadow-slate-200 group active:scale-95 text-xs uppercase"
          >
        ...
        <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden transition-all hover:shadow-md">
          <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input 
                type="text" 
                placeholder="localizar usuário ou cargo..." 
      ...
      {/* modal de cadastro integrado r s */}
      <FormUsuarioSistema 
